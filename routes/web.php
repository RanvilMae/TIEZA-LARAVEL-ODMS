...
Route::get('/admin/tag_tosector', 'AdminController@tag_tosector');
Route::get('/admin/tag_todept', 'AdminController@tag_todept');
Route::get('/admin/tag_todiv', 'AdminController@tag_todiv');
Route::get('/admin/tag_topersonnel', 'AdminController@tag_topersonnel');
Route::post('/admin/uploadprocess', 'AdminController@uploadprocess');
Route::post('/admin/save_tag', 'AdminController@save_tag');
Route::post('/admin/save_tagsector', 'AdminController@save_tagsector');
Route::post('/admin/save_tagdept', 'AdminController@save_tagdept');
Route::post('/admin/save_tagdiv', 'AdminController@save_tagdiv');
Route::post('/admin/save_tagperson', 'AdminController@save_tagperson');
...
Route::get('/admin/incoming', 'AdminController@incoming');
Route::get('/admin/logout', 'AdminController@logout');
Route::get('/admin/pdf_status', [AdminController::class, 'generatePDF']);
Route::get('/admin/pdf_tagging', [AdminController::class, 'generatePDF_tagging']);
